...
<html>
  <head>
	...
	function clicked()
	{
	  for (var i = 0; i < "<?php echo $num_imgs; ?>"; ++i)
	  {
		var checkBoxId = "check" + i;
		var productUrlId = "product_url" + i;
		if (document.getElementById(checkBoxId).checked)
		{
			checkedUrls.push(document.getElementById(productUrlId).value);
		}
	  }
	  choosePrices.monitorPrices(checkedUrls);
	}
	</script>
  </head>
  ...
  <body>
	<table>
		<tr><td width="100" align=right><input type="button" name="save" id="save" value="Monitor selected prices" onClick="clicked()"/></td></tr>
	</table>
  </body>
</html>
